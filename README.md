...
The wrapper mirrors unwrapped startup behavior by prepending runtime/pack paths and loading bundled plugins, while the generated Lua is rewritten to use PATH-based tool names instead of `/nix/store/.../bin/...`.
